...
exports.deleteImage = function(req, res){
	...
	//     copyImgAsThumb : false
	// };
	// deleteOptions.uploadUrl = deleteOptions.uploadUrl + target + '/' + id + '/';
	// deleteOptions.uploadDir = deleteOptions.uploadDir + target + '/' + id + '/';
 ...
 //    });
    ...
    var filePath = path.join(__dirname, '../../public/user_asset/'+ target + '/' + id + '/' + image)
